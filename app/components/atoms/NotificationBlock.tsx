...
const ErrorNotificationBlock: React.FC<NotificationBlockProps> = ({ message }) => (
  <div className="flex pt-12 items-center justify-center h-screen text-lg font-semibold shadow-md">
...
const InfoNotificationBlock: React.FC<NotificationBlockProps> = ({ message }) => (
  <div className="flex pt-24 items-start justify-center h-screen text-lg font-semibold shadow-md">
